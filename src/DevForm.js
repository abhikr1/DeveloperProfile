    ...
    return (
        <div class="formContainer">
            <form>
                ...
                <input className="labelInput" name="twitter" onInput={this.onInput} value={this.state.twitter} placeholder="abhikr1" type="text" />
                <div className="labelInput">
                    <img className="companyIcon" src={'/images/iconfinder_Circled_Medium_svg5_5279113.png'} alt="icon" />
                    <label>Medium</label>
                </div>
                <input className="labelInput" name="medium" onInput={this.onInput} placeholder="abhikr1"
